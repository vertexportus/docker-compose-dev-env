...
class Docker(base_command.BaseCommand):
    ...
    def argparse(parser, subparsers):
        ...
        parser_down.add_argument('params', nargs=argparse.REMAINDER, help='additional arguments passed directly into docker-compose down')
        # docker destroy
        ...
        parser_exec.add_argument('params', nargs=argparse.REMAINDER, help="additional parameters for container exec_command")
        # docker logs
